...
Page {
    ...
    ListView {
        ...
        delegate: Loader {
            id: theLoader
            sourceComponent: model.modelData.sessionsPropertyList.length? speakerRowComponent : emptyComponent
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                LabelSubheading {
                                    rightPadding: 12
                                    text: model.modelData.name.length? model.modelData.name : qsTr("Unnamed Author")
                                    font.bold: true
