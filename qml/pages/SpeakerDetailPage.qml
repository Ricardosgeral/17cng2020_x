            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        LabelHeadline {
                            text: speaker.name.length? speaker.name : qsTr("Unnamed Authors")
                            color: accentColor
                        }
                        LabelSubheading {
                ...
                LabelBodySecondary {
                    ...
                    leftPadding: 16
                    font.italic: true
                    text: qsTr("Tap on an Article to get the Details.\nTap on the Star Icon to add/remove from your selection.")
                    wrapMode: Text.WordWrap
                }
                                                ...
                                                MouseArea {
                                                    ...
                                                    onClicked: {
                                                        ...
                                                        if(modelData.isFavorite) {
                                                            appWindow.showToast(qsTr("Added to your selection"))
                                                        } else {
