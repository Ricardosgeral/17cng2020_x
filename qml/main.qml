...
ApplicationWindow {
    ...
    onMyScheduleActiveChanged: {
        if(myScheduleActive) {
            ...
            drawerLoader.item.replaceText(scheduleNavigationIndex,qsTr("My Favorites"))
            favoritesLoader.item.replaceIcon(scheduleFavoritesIndex,"stars.png")
            favoritesLoader.item.replaceText(scheduleFavoritesIndex,qsTr("My Favorites"))
        } else {
            //navigationModel[2].icon = "schedule.png"
            drawerLoader.item.replaceIcon(scheduleNavigationIndex,"schedule.png")
            drawerLoader.item.replaceText(scheduleNavigationIndex,qsTr("Program"))
            favoritesLoader.item.replaceIcon(scheduleFavoritesIndex,"schedule.png")
            favoritesLoader.item.replaceText(scheduleFavoritesIndex,qsTr("Program"))
        }
    }
    ...
    property int fontSizeDisplay4: 90
    property int fontSizeDisplay3: 46
    property int fontSizeDisplay2: 38
    property int fontSizeDisplay1: 25
    property int fontSizeHeadline: 19
    ...
    property var navigationModel: [
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Home"), "icon": "home.png", "source": "../pages/HomePage.qml", "showCounter":false, "showMarker":false, "a_p":1, "canGoBack":false},
        {"type": "../navigation/DrawerDivider.qml", "name": "", "icon": "", "source": "", "a_p":1, "canGoBack":false},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Program"), "icon": "schedule.png", "source": "../navigation/ScheduleNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Authors"), "icon": "supervisor.png", "source": "../navigation/SpeakerNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Topics"), "icon": "tag.png", "source": "../navigation/TrackNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        {"type": "../navigation/DrawerNavigationButton.qml", "name": qsTr("Venue"), "icon": "business.png", "source": "../navigation/VenueNavigation.qml", "showCounter":false, "showMarker":false, "a_p":2, "canGoBack":true},
        ...
        {"type": "../navigation/DrawerNavigationTextButton.qml", "name": qsTr("About the App"), "icon": "", "source": "../pages/AboutPage.qml", "showCounter":false, "showMarker":false, "a_p":3, "canGoBack":false}
    ]
